...
import resume from "./Ayla-Basha-Resume-2022.pdf";
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-9">
                                <div className="menu_wrapper">
                                    <Scrollspy className="mainmenuwrapper" items={['home','about', 'portfolio',  'resume' , 'contact']} currentClassName="is-current" offset={-200}>
                                        <li>
