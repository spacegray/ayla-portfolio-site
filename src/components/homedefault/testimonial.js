                    ...
                    <TabContent activeTab={activeTab}>
                      <TabPane tabId="1">
                        <div className="testimonial-inner">
                          ...
                          <p>
                            Ayla has been great to work with. She is a dynamic
                            programmer that brings and intuitive flow to her
                            work. She was able to listen to my vision and turn
                            it into a tangible product
                          </p>
                          <div className="client-info">
                            <div className="thumbnail">
                              <img
                                src={testimonialOne}
                                alt="Testimonail Images"
                              />
                            </div>
                            <div className="info">
                              <h3 className="title">Stevie Collins</h3>
                      ...
                      <TabPane tabId="2">
                        <div className="testimonial-inner">
                          ...
                          <p>
                            I can't believe I got support and my problem
                            resolved in just minutes from posting my question.
                            Simply amazing team and amazing theme! Thank you
                            very much guys for excellent support! I can't
                            believe I got support and my problem resolved in
                            just minutes from posting my question. Simply
                            amazing team and amazing theme! Thank you very much
                            guys for excellent support!{" "}
                          </p>
                          <div className="client-info">
                            <div className="thumbnail">
                              <img
                      ...
                      <TabPane tabId="3">
                        <div className="testimonial-inner">
                          ...
                          <div className="client-info">
                            ...
                            <div className="info">
                              <h3 className="title">Nathan Henderson</h3>
                              <span>Web Designer</span>
                            </div>
                          </div>
                        </div>
